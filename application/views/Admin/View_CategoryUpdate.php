        ...
        <div class="page-header">
            <div class="page-title">
                <ol class="breadcrumb text-right">
                    ...
                    <li class="active"><?php echo $detail[0]['TenLoaiMonAn']; ?></li>
                </ol>
            </div>
        </div>
    </div>
                ...
                <div class="basic-form">
                    <form method="POST" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Tên Loại Món Ăn *" name="tenloaimonan" value="<?php echo $detail[0]['TenLoaiMonAn']; ?>">
                        </div>
                        <div class="form-group">
                            <label>Mô Tả</label>
                        ...
                        <div>
                            ...
                            <?php if($_SESSION['role'] == 1){ ?>
                        	    <button type="submit" class="btn btn-primary">Cập Nhật Loại Món Ăn</button>
                            <?php } ?>
                        </div>
                    </form>
                </div>
